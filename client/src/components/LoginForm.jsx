...
export function LoginForm() {
    ...
    return (
        <form onSubmit={handleFormSubmit} className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4">
            ...
            <div className="mb-4">
                <label htmlFor="username_or_email" className="form-label">Slapyvardis arba El. paštas</label>
            ...
            <div className="mb-4">
                <button type="submit" className="btn btn-info w-100 py-2 fs-5">Prisijungti</button>
            </div>
        </form>
    );
}