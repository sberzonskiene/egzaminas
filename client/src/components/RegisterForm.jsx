    ...
    return (
        <form onSubmit={handleFormSubmit} className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4">
            ...
            <div className="mb-4">
                ...
                <label style={{ lineHeight: '1.5rem' }} htmlFor="tos">Sutikti su puslapio taisyklėmis</label>
                <div className="invalid-feedback">{tosErr}</div>
            </div>
            <div className="mb-4">
                <button type="submit" className="btn btn-info w-100 py-2 fs-5">Registruotis</button>
            </div>
        </form>
    );
} 